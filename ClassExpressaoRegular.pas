...
// If Result <> 0, then ASubExpr can contain empty items or illegal ones
  ...
  type
    TExpressaoRegular = class(TPersistent)
      function SearchStringForRegularExpression(strString:string; strRegex: string; var ListaDeResultados: TStringList): string;
      procedure GetListaDeArquivosContendoRegex(path : String; var listaArquivos : TStringList; regex : String; incluirPathNoNome: boolean=false);
  end;
...
uses
 Windows{, ExceptLog}; // CharUpper/Lower
...
function TExpressaoRegular.SearchStringForRegularExpression(strString             : string;
                                                            strRegex              : string;
                                                            var ListaDeResultados :  TStringList): string;
var
  sExpressao: string;
  r : TRegExpr;
  bExecutou: boolean;
    ...
    try
      ...
      begin
        REPEAT
          ...
          if sLinhaAtual <> '' then
            ListaDeResultados.Add(sLinhaAtual);
...
procedure TExpressaoRegular.GetListaDeArquivosContendoRegex(path : String; var listaArquivos : TStringList; regex : String; incluirPathNoNome: boolean=false);
var
  Arq: TSearchRec;
  dir: String;
  sNomeArquivo: string;
    ...
    begin
      repeat
        ...
        begin
          ...
          SearchStringForRegularExpression(sNomeArquivo, regex, slMatches);
